...
# Retail markup components (€/Wh)
# Approximate breakdown for German industrial customers:
#   - Network fees (Netzentgelte): ~6 ct/kWh
#   - EEG surcharge (reduced for industry): ~0.5 ct/kWh  
#   - Other levies & taxes: ~2 ct/kWh
#   - Supplier margin: ~0.5 ct/kWh
# Total retail markup: ~9 ct/kWh = 0.00009 €/Wh
RETAIL_MARKUP_EUR_PER_WH = 0.00009  # 9 ct/kWh
